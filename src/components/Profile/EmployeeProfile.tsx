          ...
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <p className="text-sm text-gray-500">
                Notify HR that you want to participate in the cooperative scheme.
              </p>
            </DialogHeader>
                ...
                <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => dispatch(setFormData({ ...formData, message: e.target.value }))}
                    />
                  </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <span>Joined: {user?.employmentDate ? new Date(user.employmentDate).toLocaleDateString() : 'N/A'}</span>
              </div>
            </div>
          </CardContent>
        </Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => dispatch(setFormData({ ...formData, middleName: e.target.value }))}
                      disabled={!isEditing}
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => dispatch(setFormData({ ...formData, gender: e.target.value }))}
                      disabled={!isEditing}
                    />
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => dispatch(setFormData({ ...formData, stateOfOrigin: e.target.value }))}
                      disabled={!isEditing}
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      id="city"
                      value={formData.city}
                      onChange={(e) => dispatch(setFormData({ ...formData, city: e.target.value }))}
                      disabled={!isEditing}
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => dispatch(setFormData({ ...formData, mobile: e.target.value }))}
                    disabled={!isEditing}
                  />
                </div>
              </CardContent>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => dispatch(setFormData({ ...formData, officeBranch: e.target.value }))}
                      disabled={!isEditing}
                    />
                  </div>
                  <div>
          ...
          <TabsContent value="account">
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      disabled={!isEditing}
                      onChange={(e) =>
                        dispatch(setFormData({ ...formData, accountInfo: { ...formData.accountInfo, classLevel: e.target.value } }))
                      }
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      disabled={!isEditing}
                      onChange={(e) =>
                        dispatch(setFormData({ ...formData, accountInfo: { ...formData.accountInfo, basicPay: Number(e.target.value) } }))
                      }
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      disabled={!isEditing}
                      onChange={(e) =>
                        dispatch(setFormData({ ...formData, accountInfo: { ...formData.accountInfo, bank: e.target.value } }))
                      }
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      disabled={!isEditing}
                      onChange={(e) =>
                        dispatch(setFormData({ ...formData, accountInfo: { ...formData.accountInfo, accountNumber: e.target.value } }))
                      }
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="pensionFundAdministrator">Pension Administrator</Label>
                    <Input
                      ...
                      onChange={(e) =>
                        dispatch(setFormData({
                          ...formData,
                          accountInfo: { ...formData.accountInfo, pensionFundAdministrator: e.target.value },
                        }))
                      }
                    />
                  </div>
                  <div>
                    <Label htmlFor="pensionAccountNumber">Pension Account Number</Label>
                    <Input
                      ...
                      onChange={(e) =>
                        dispatch(setFormData({
                          ...formData,
                          accountInfo: { ...formData.accountInfo, pensionAccountNumber: e.target.value },
                        }))
                      }
                    />
                  </div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      dispatch(
                        setFormData({
                          ...formData,
                          accountInfo: { ...formData.accountInfo, allowances: e.target.value.split(",") },
                        })
                      )
                    }
                  />
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        dispatch(setFormData({ ...formData, nextOfKin: { ...formData.nextOfKin, name: e.target.value } }))
                      }
                      disabled={!isEditing}
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        dispatch(setFormData({ ...formData, nextOfKin: { ...formData.nextOfKin, phone: e.target.value } }))
                      }
                      disabled={!isEditing}
                    />
                  </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      dispatch(setFormData({ ...formData, nextOfKin: { ...formData.nextOfKin, email: e.target.value } }))
                    }
                    disabled={!isEditing}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      dispatch(
                        setFormData({ ...formData, nextOfKin: { ...formData.nextOfKin, relationship: e.target.value } })
                      )
                    }
                    disabled={!isEditing}
                  />
