...
export default function BasicInfoSection({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <Input
            ...
            value={formData.lga || ""}
            onChange={(e) =>
              dispatch(setFormData({ ...formData, lga: e.target.value }))
            }
        ...
        <div>
          ...
          <Input
            ...
            value={formData.town || ""}
            onChange={(e) =>
              dispatch(setFormData({ ...formData, town: e.target.value }))
            }
      ...
      {/* Row 7: Mobile + Alternate Phone Number */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <Label htmlFor="mobile">Mobile</Label>
          <Input
      ...
      {/* Row 8: Means of Identification + ID Number */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <Label htmlFor="meansOfIdentification">Means of Identification</Label>
          <Select
            value={formData.meansOfIdentification ?? "none"}
            onValueChange={(val) =>
              dispatch(
                setFormData({
                  ...formData,
          ...
          >
            ...
            <SelectContent className="max-h-60 overflow-y-auto">
              ...
              {MEANS_OF_IDENTIFICATION.map((id) => (
        ...
        <div>
          <Label htmlFor="meansOfIdentificationNumber">ID Number</Label>
          <Input
            id="meansOfIdentificationNumber"
            value={formData.meansOfIdentificationNumber || ""}
            onChange={(e) =>
              dispatch(
                setFormData({
                  ...formData,
                  meansOfIdentificationNumber: e.target.value,
                })
              )
            }
      ...
      {/* Row 9: State of Issuance + National ID Number */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <Label htmlFor="stateOfIssuance">State of Issuance</Label>
          <Select
            value={formData.stateOfIssuance ?? "none"}
            onValueChange={(val) =>
              dispatch(
                setFormData({
                  ...formData,
                  stateOfIssuance: val === "none" ? undefined : val,
                })
              )
            }
          >
            <SelectTrigger>
              <SelectValue placeholder="Select state of issuance" />
            </SelectTrigger>
            <SelectContent className="max-h-60 overflow-y-auto">
              <SelectItem value="none">---select state---</SelectItem>
              {NIGERIAN_STATES.map((state) => (
