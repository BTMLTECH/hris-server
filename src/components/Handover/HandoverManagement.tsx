...
const HandoverManagement: React.FC = () => {
  ...
  // const { teamLead } = useAppSelector((state) => state.leave);
  ...
  //   reportId: string,
  //   newStatus: HandoverReport["status"]
  // ) => {
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">
            Submit and manage daily handover reports
          </p>
        </div>
          ...
          >
            ...
            <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
              <DialogHeader>
                ...
                <DialogDescription>
                  Upload your daily handover report in PDF format along with a
                  summary
                </DialogDescription>
              </DialogHeader>
                ...
                <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value: "day" | "night") =>
                          dispatch(setFormData({ shift: value }))
                        }
                      >
                        <SelectTrigger>
                          <SelectValue />
                  ...
                  {/* <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        dispatch(setFormData({ teamleadId: value }))
                      }
                    >
                      <SelectTrigger>
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        dispatch(
                          setFormData({ ...formData, teamleadId: value })
                        )
                      }
                    >
                      <SelectTrigger>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) =>
                        dispatch(setFormData({ summary: e.target.value }))
                      }
        ...
        <TabsContent value="my-reports">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                View and track your submitted handover reports
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                            ...
                            {report.pdfFile && (
                              <>
                                ...
                                <Button
                                  ...
                                  variant="ghost"
                                  onClick={() =>
                                    window.open(report.pdfFile, "_blank")
                                  }
                                >
                                  View
                                </Button>
